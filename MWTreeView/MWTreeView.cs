...
/// </summary>
namespace PaJaMa.WinControls.MWTreeView
{
	/// <summary>
	...
	public class MWTreeView : System.Windows.Forms.TreeView
	{
						...
						if (this.AllowKeyF2LabelEditing)
						{
								...
								bRubberbandHasBeenPainted && MWTreeView.MouseButtons == MouseButtons.None))
							{
								if (this.HotTracking)
								{
									...
									else if (this._selectedNodeWrappers.Count > 0)
									{
										foreach (MWTreeNodeWrapper mwtnw in this._selectedNodeWrappers.Values)
										{
		...
		protected override void OnMouseLeave(System.EventArgs e)
		{
			if (this.MultiSelect != TreeViewMultiSelect.Classic)
			{
				if (bRubberbandHasBeenPainted)
				{
					...
					if (this._selectedNodeWrappers.Count > 0 && tn != null)
					{
		...
		public event PaJaMa.WinControls.MWTreeView.MWRubberbandClearEventHandler RubberbandClear;
		...
		public event PaJaMa.WinControls.MWTreeView.MWRubberbandPaintEventHandler RubberbandPaint;
		...
		/// </summary>
		public delegate void MWCancelEventHandler(object sender, PaJaMa.WinControls.MWTreeView.MWCancelEventArgs e);
		...
		/// </summary>
		public delegate void MWPropertyEventHandler(object sender, PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs e);
		...
		/// </summary>
		public delegate void MWRubberbandPaintEventHandler(object sender, PaJaMa.WinControls.MWTreeView.MWRubberbandPaintEventArgs e);
		...
		/// </summary>
		public delegate void MWRubberbandClearEventHandler(object sender, PaJaMa.WinControls.MWTreeView.MWRubberbandClearEventArgs e);
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeDisabledTreeNodeBackColorChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeDisabledTreeNodeForeColorChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeUseExtendedDisabledColorsChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowMultiCheckChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeCheckNodeRegExChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowMultipleExpandedPathsChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeExpandBeforeCollapseChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeCollapseTreeNodeOnDeselectChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeCollapseTreeNodeOnSelectChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeExpandTreeNodeOnDeselectChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeExpandTreeNodeOnSelectChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowControlKeyNavigationChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowKeyASelectAllChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowKeyEExpandAllChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowKeyEscapeDeselectAllChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowKeyF2LabelEditingChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowKeyQCollapseAllChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowKeyboardModKeyAltChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowKeyboardModKeyControlChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowKeyboardModKeyShiftChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowMouseModKeyAltChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowMouseModKeyControlChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowMouseModKeyShiftChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowBlankNodeTextChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeDisallowLabelEditRegExChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeLabelEditRegExChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeLabelEditTimeoutChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeMouseClearSelNodesChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeConstrainedShiftKeySelectionChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowOutOfFocusRubberbandSelectionChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeConstrainedRubberbandSelectionChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandSelectionChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandSelectionExpandCollapseTimeoutChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandBorderColorChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandBorderColorAlphaChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandBorderThicknessChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeUseRubberbandBorderChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandFillColorChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandFillColorAlphaChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandGradientAngleChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandGradientBlendChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandGradientColorBlendChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandGradientColor1Changed;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandGradientColor1AlphaChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandGradientColor2Changed;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandGradientColor2AlphaChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandGradientLinearGradientModeChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandGradientPaintModeChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandGradientShapeChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandGradientShapeFocusChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandGradientShapeScaleChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandHatchBackColorChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandHatchBackColorAlphaChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandHatchForeColorChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandHatchForeColorAlphaChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandHatchStyleChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandImageChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandImageScaleCorrectionChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandImageTransparencyChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandSelectionFrameActiveChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeRubberbandUpdateTimeoutChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeUseRubberbandUpdateMouseHoverChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeUseRubberbandUpdateTimerChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeAllowNoSelNodeChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeExtendedTemporaryMarkingChanged;
				...
				if (tvmsMultiSelect != value)
				{
					...
					if (!e.Cancel)
					{
						...
						else if (value == TreeViewMultiSelect.MultiAllDescendants)
						{
							...
							this._selectedNodeWrappers = new Hashtable();
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeMultiSelectChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeScrollToSelNodeChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeSelectNodeRegExChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeSelectedTreeNodeBackColorChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeSelectedTreeNodeForeColorChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeUseExtendedSelectionColorsChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeCheckedNodesChanged;
		...
		private void SetSelNodeInt(TreeNode value, bool bTriggerSelNodeEvents)
		{
			if (tnSelNode != value)
			{
				...
				if (!e.Cancel)
				{
					...
					if (bTriggerSelNodeEvents)
					{
						OnAfterSelNodeChanged(new PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs(tnSelNode));
					}
				}
			}
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeSelNodeChanged;
		...
		public event PaJaMa.WinControls.MWTreeView.MWPropertyEventHandler AfterSelNodeChanged;

		/// <summary>
		/// Raises the AfterSelNodeChanged Event.
		/// </summary>
		/// <param name="e">Standard EventArgs object.</param>
		public void OnAfterSelNodeChanged(PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs e)
		{
		...
		public List<TreeNode> SelectedNodes
		{
			get
			{
				...
				foreach (MWTreeNodeWrapper nw in _selectedNodeWrappers.Values)
				{
					nodes.Add(nw.Node);
				}
				return nodes;
		...
		private Hashtable _selectedNodeWrappers
		{
			get
			{
				return htSelNodes;
				...
				if (htSelNodes != value)
				{
					...
					if (!e.Cancel)
					{
						if (value == null)
						{
							...
							if (this._selectedNodeWrappers == null)
							{
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeSelNodesChanged;
		...
		private TreeNode TreeNodeMouseDownInt
		{
			...
			set
			{
				if (tnMouseDown != value)
				{
					...
					OnAfterTreeNodeMouseDownChanged(new PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs(tnMouseDown));
				}
			}
		}
		...
		public event PaJaMa.WinControls.MWTreeView.MWPropertyEventHandler AfterTreeNodeMouseDownChanged;

		/// <summary>
		/// Raises the AfterTreeNodeMouseDownChanged Event.
		/// </summary>
		/// <param name="e">Standard EventArgs object.</param>
		public void OnAfterTreeNodeMouseDownChanged(PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs e)
		{
		...
		private bool CheckedNodesAdd(TreeNode tn, bool bTriggerEvents)
		{
			...
			if (!this.IsTreeNodeChecked(tn))
			{
				...
				if (!e.Cancel)
				{
					...
					if (bTriggerEvents)
					{
						OnAfterCheckedNodesAdd(new PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs(tn));
					}
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeCheckedNodesAdd;
		...
		public event PaJaMa.WinControls.MWTreeView.MWPropertyEventHandler AfterCheckedNodesAdd;

		/// <summary>
		/// Raises the AfterCheckedNodesAdd Event.
		/// </summary>
		/// <param name="e">Standard EventArgs object.</param>
		public void OnAfterCheckedNodesAdd(PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs e)
		{
		...
		private bool CheckedNodesRemove(TreeNode tn, bool bTriggerEvents)
		{
			...
			if (this.IsTreeNodeChecked(tn))
			{
				...
				if (!e.Cancel)
				{
					...
					if (bTriggerEvents)
					{
						OnAfterCheckedNodesRemove(new PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs(tn));
					}
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeCheckedNodesRemove;
		...
		public event PaJaMa.WinControls.MWTreeView.MWPropertyEventHandler AfterCheckedNodesRemove;

		/// <summary>
		/// Raises the AfterCheckedNodesRemove Event.
		/// </summary>
		/// <param name="e">Standard EventArgs object.</param>
		public void OnAfterCheckedNodesRemove(PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs e)
		{
		...
		private bool SelNodesAdd(TreeNode tn, bool bTriggerEvents)
		{
			...
			{
				MWCancelEventArgs e = new MWCancelEventArgs(this._selectedNodeWrappers, tn);
				...
				if (!e.Cancel)
				{
					this._selectedNodeWrappers.Add(tn.GetHashCode(), new MWTreeNodeWrapper(tn, this.UseExtendedSelectionColors, this.SelectedTreeNodeBackColor, this.SelectedTreeNodeForeColor));
					...
					if (bTriggerEvents)
					{
						OnAfterSelNodesAdd(new PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs(tn));
					}
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeSelNodesAdd;
		...
		public event PaJaMa.WinControls.MWTreeView.MWPropertyEventHandler AfterSelNodesAdd;

		/// <summary>
		/// Raises the AfterSelNodesAdd Event.
		/// </summary>
		/// <param name="e">Standard EventArgs object.</param>
		public void OnAfterSelNodesAdd(PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs e)
		{
		...
		private bool SelNodesRemove(TreeNode tn, bool bTriggerEvents)
		{
			...
			if (this.IsTreeNodeSelected(tn))
			{
				...
				if (!e.Cancel)
				{
					MWTreeNodeWrapper.Deselect(this._selectedNodeWrappers[tn.GetHashCode()] as MWTreeNodeWrapper);

					this._selectedNodeWrappers.Remove(tn.GetHashCode());

					if (bTriggerEvents)
					{
						OnAfterSelNodesRemove(new PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs(tn));
					}
		...
		public event PaJaMa.WinControls.MWTreeView.MWCancelEventHandler BeforeSelNodesRemove;
		...
		public event PaJaMa.WinControls.MWTreeView.MWPropertyEventHandler AfterSelNodesRemove;

		/// <summary>
		/// Raises the AfterSelNodesRemove Event.
		/// </summary>
		/// <param name="e">Standard EventArgs object.</param>
		public void OnAfterSelNodesRemove(PaJaMa.WinControls.MWTreeView.MWPropertyEventArgs e)
		{
		...
		public bool IsTreeNodeSelected(TreeNode tn)
		{
			...
			if (tn != null)
			{
				if (this._selectedNodeWrappers != null)
				{
					if (this._selectedNodeWrappers.Contains(tn.GetHashCode()))
					{
						bRetVal = true;
					}
				}
		...
		protected void ClearSelNodes(bool bTriggerSelNodesAddRemoveEvents)
		{
			if (this._selectedNodeWrappers != null)
			{
				int iMax = this._selectedNodeWrappers.Count;
		...
		public void ClearSelNodes(TreeNode tn, bool bTriggerSelNodesAddRemoveEvents)
		{
			...
			else if (this._selectedNodeWrappers != null)
			{
				int iMax = this._selectedNodeWrappers.Count;
		...
		private void ClearSelNodesForce()
		{
			if (this._selectedNodeWrappers != null)
			{
				...
				this._selectedNodeWrappers.Clear();
			}
			else
			{
				this._selectedNodeWrappers = new Hashtable();
		...
		public bool EnsureSelNodeNotNull()
		{
			...
			if (this.SelNode == null)
			{
				if (this._selectedNodeWrappers != null)
				{
					if (this._selectedNodeWrappers.Count > 0)
					{
						if (this.SelNode == null)
						{
							foreach (MWTreeNodeWrapper mwtnw in this._selectedNodeWrappers.Values)
		...
		public bool RemoveSelectedNodes(bool bRemoveTreeNodeMouseDownIfNotSelected)
		{
			...
			if (RemoveNodes(this._selectedNodeWrappers))
			{
				bRetVal = true;
			}
		...
		protected bool SelectNode(TreeNode tn, bool bChangeSelNode, bool bTriggerSelNodesAddRemoveEvents, bool bTriggerSelNodeEvents)
		{
			...
			if (tn != null)
			{
				...
				switch (this.MultiSelect)
				{
					...
					case TreeViewMultiSelect.MultiSameBranchAndLevel:
						if (this._selectedNodeWrappers != null && this._selectedNodeWrappers.Count > 0)
						{
		...
		protected bool DeselectNode(TreeNode tn, bool bChangeSelNode, bool bTriggerSelNodesAddRemoveEvents)
		{
			...
			if (tn != null && this._selectedNodeWrappers.Count > 0 && IsTreeNodeSelected(tn))
			{
				if (this.MultiSelect == TreeViewMultiSelect.MultiPathToParent ||
					this.MultiSelect == TreeViewMultiSelect.MultiPathToParents ||
					this.MultiSelect == TreeViewMultiSelect.SinglePathToParent ||
			...
			if (!this.AllowNoSelNode && this._selectedNodeWrappers.Count == 1)
			{
				bDeselectNode = false;
			}
		...
		protected bool ToggleNode(TreeNode tn, bool bChangeSelNode, bool bTriggerSelNodesAddRemoveEvents)
		{
			...
			if (this._selectedNodeWrappers != null && IsTreeNodeSelected(tn))
			{
				DeselectNode(tn, bChangeSelNode);
			}
			else
		...
		private void DeactivateSelNode(TreeNode tn)
		{
			if (tn != null)
			{
				MWTreeNodeWrapper mwtnw = this._selectedNodeWrappers[tn.GetHashCode()] as MWTreeNodeWrapper;
		...
		{
			if (this.Enabled && this._selectedNodeWrappers != null)
			{
				if (this.UseExtendedSelectionColors)
				{
					foreach (MWTreeNodeWrapper mwtnw in this._selectedNodeWrappers.Values)
		...
		public static void ChangeTreeNodeImageIndex(TreeNode tn, int iImageIndex)
		{
			if (tn != null)
			{
				if ((tn.TreeView as MWTreeView).IsTreeNodeSelected(tn))
				{
					MWTreeNodeWrapper mwtnw = (tn.TreeView as MWTreeView)._selectedNodeWrappers[tn.GetHashCode()] as MWTreeNodeWrapper;
