...
namespace PaJaMa.WinControls.FileBrowser
{
    ...
    /// </summary>
    internal class FileBrowserTVDragWrapper : IDropSource, IDisposable
    {
        #region Fields

        // The FileBrowser for which to do the drag work
        ...
        /// </summary>
        /// <param name="br">The FileBrowser for which to support the drag</param>
        public FileBrowserTVDragWrapper(FileBrowser br)
        {
            this.br = br;
            br.FolderView.ItemDrag += new ItemDragEventHandler(ItemDrag);
        }

        ~FileBrowserTVDragWrapper()
        {
    ...
    /// <summary>
    /// This class takes care of every drag operation in a FileBrowserListView
    /// </summary>
    internal class FileBrowserLVDragWrapper : IDropSource, IDisposable
    {
        #region Fields
        ...
        /// </summary>
        /// <param name="br">The FileBrowser for which to support the drag</param>
        public FileBrowserLVDragWrapper(FileBrowser br)
        {
            this.br = br;
            br.FileView.ItemDrag += new ItemDragEventHandler(ItemDrag);
        }

        ~FileBrowserLVDragWrapper()
        {
            ((IDisposable)this).Dispose();
        }
