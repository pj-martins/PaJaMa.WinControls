...
{
    /// <summary>
    /// This class takes care of every drop operation in a FileBrowserTreeView
    /// </summary>
    internal class FileBrowserTVDropWrapper : ShellDll.IDropTarget, IDisposable
    {
        #region Fields

        // The FileBrowser for which to do the drop work
        ...
        // The last selected node from the FileBrowser
        ...
        /// </summary>
        /// <param name="br">The FileBrowser for which to support the drop</param>
        public FileBrowserTVDropWrapper(FileBrowser br)
        {
            this.br = br;
    ...
    /// <summary>
    /// This class takes care of every drop operation in a FileBrowserListView
    /// </summary>
    internal class FileBrowserLVDropWrapper : ShellDll.IDropTarget, IDisposable
    {
        #region Fields
        ...
        /// </summary>
        /// <param name="br">The FileBrowser for which to support the drop</param>
        public FileBrowserLVDropWrapper(FileBrowser br)
        {
            this.br = br;
