...
namespace PaJaMa.WinControls.FileBrowser
{
    ...
    /// </summary>
    internal class FileBrowserTVContextMenuWrapper : NativeWindow
    {
        #region Fields

        // The FileBrowser for which to provide the context menu's
        private FileBrowser br;
        ...
        /// </summary>
        /// <param name="br">The FileBrowser for which to support the ContextMenu</param>
        public FileBrowserTVContextMenuWrapper(FileBrowser br)
        {
            this.br = br;
        ...
        /// method of FileBrowser when hovering over a ContextMenu item.
        /// </summary>
        /// <param name="m">the Message of the FileBrowser's WndProc</param>
    ...
    /// <summary>
    /// This class takes care of showing ContextMenu's for a FileBrowserListView and 
    /// executing items when pressing enter or double clicking
    /// </summary>
    internal class FileBrowserLVContextMenuWrapper : NativeWindow
    {
        #region Fields
        ...
        /// </summary>
        /// <param name="br">The FileBrowser for which to support the ContextMenu</param>
        public FileBrowserLVContextMenuWrapper(FileBrowser br, FileBrowserPluginWrapper pluginWrapper)
        {
            this.br = br;
        ...
        private void CreateFolderMenu(Point ptInvoke, MouseEventArgs e)
        {
            ...
            try
            {
                ...
                if (!br.SelectedItem.Equals(br.ShellFileBrowser.DesktopItem))
                {
                    ShellAPI.AppendMenu(contextMenu, ShellAPI.MFT.SEPARATOR, 0, string.Empty);
    ...
    internal static class ContextMenuHelper
    {
        ...
        /// Ctrl + C and Ctrl + V.
        /// </summary>
        public static void ProcessKeyCommands(FileBrowser br, object sender, KeyEventArgs e)
        {
