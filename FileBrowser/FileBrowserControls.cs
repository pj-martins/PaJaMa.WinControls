...
namespace PaJaMa.WinControls.FileBrowser
{
    ...
    internal class FileBrowserTreeView : TreeView
    {
        ...
        {
            HandleCreated += new EventHandler(FileBrowserTreeView_HandleCreated);

            sorter = new FileBrowserTreeSorter();
        }
        ...
        /// </summary>
        void FileBrowserTreeView_HandleCreated(object sender, EventArgs e)
        {
    ...
    /// <summary>
    /// This class is used to sort the TreeNodes in the FileBrowserTreeView
    /// </summary>
    internal class FileBrowserTreeSorter : IComparer
    {
    ...
    /// <summary>
    /// This is the ListView used in the FileBrowser control
    /// </summary>
    internal class FileBrowserListView : ListView
    {
        #region Fields
        ...
        private FileBrowserListSorter sorter;
        ...
        public FileBrowserListView()
        {
            ...
            HandleCreated += new EventHandler(FileBrowserListView_HandleCreated);
            selectedOrder = new ArrayList();
            SetStyle(ControlStyles.OptimizedDoubleBuffer, true);
            SetStyle(ControlStyles.AllPaintingInWmPaint, true);

            DrawItem += new DrawListViewItemEventHandler(FileBrowserListView_DrawItem);
            DrawSubItem += new DrawListViewSubItemEventHandler(FileBrowserListView_DrawSubItem);
            DrawColumnHeader += new DrawListViewColumnHeaderEventHandler(FileBrowserListView_DrawColumnHeader);

            this.Alignment = ListViewAlignment.Left;
            sorter = new FileBrowserListSorter();
        }

        #region Owner Draw

        void FileBrowserListView_DrawItem(object sender, DrawListViewItemEventArgs e)
        {
            e.DrawDefault = true;
        }

        void FileBrowserListView_DrawSubItem(object sender, DrawListViewSubItemEventArgs e)
        {
            e.DrawDefault = true;
        }

        void FileBrowserListView_DrawColumnHeader(object sender, DrawListViewColumnHeaderEventArgs e)
        {
            e.DrawDefault = true;
    ...
    /// <summary>
    /// This class is used to sort the ListViewItems in the FileBrowserListView
    /// </summary>
    internal class FileBrowserListSorter : IComparer
    {
        #region IComparer Members
    ...
    /// ShellItems.
    /// </summary>
    internal class FileBrowserComboBox : ToolStripComboBox
    {
        #region Fields
        ...
        // The item for the FileBrowser's current selected directory
        private FileBrowserComboItem currentItem;
        ...
        protected override void OnSelectedIndexChanged(EventArgs e)
        {
            ...
            if (ComboBox.SelectedIndex > -1)
                currentItem = ComboBox.SelectedItem as FileBrowserComboItem;         
        }
        ...
        void ComboBox_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            {
                FileBrowserComboItem item = (FileBrowserComboItem)Items[e.Index];
        ...
        void ComboBox_DropDown(object sender, EventArgs e)
        {
            ...
            foreach (FileBrowserComboItem item in Items)
            {
                int itemWidth =
        ...
        [Browsable(false)]
        public FileBrowserComboItem CurrentItem 
        { 
        ...
        class ComboEditWindow : NativeWindow
        {
            ...
            private FileBrowserComboBox owner;
            ...
            /// </summary>
            public ComboEditWindow(FileBrowserComboBox owner)
            {
                this.owner = owner;
    ...
    /// <summary>
    /// This class represents the items that can be used for the FileBrowserComboBox
    /// </summary>
    internal class FileBrowserComboItem
    {
        ...
        public FileBrowserComboItem(ShellItem shellItem, int indent)
        {
