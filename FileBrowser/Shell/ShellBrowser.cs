...
namespace ShellDll
{
    public class ShellFileBrowser : Component
    {
        #region Fields
        ...
        private ShellFileBrowserUpdater updater;

		private ArrayList shellFileBrowsers;
        ...
        public ShellFileBrowser()
        {
            InitVars();
			shellFileBrowsers = new ArrayList();
            updateCondition = new ShellItemUpdateCondition();
            updater = new ShellFileBrowserUpdater(this);
        }
        ...
        #region ShellFileBrowser Update
		...
		internal ArrayList ShellFileBrowsers { get { return shellFileBrowsers; } }
