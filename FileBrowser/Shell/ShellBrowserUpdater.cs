...
namespace ShellDll
{
    internal class ShellFileBrowserUpdater : NativeWindow
    {
        #region Fields

        private ShellFileBrowser br;
        private uint notifyId = 0;

        #endregion

        public ShellFileBrowserUpdater(ShellFileBrowser br)
        {
            this.br = br;
