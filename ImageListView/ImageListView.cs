...
using PaJaMa.WinControls.ImageListView;
...
namespace Manina.Windows.Forms
{
    ...
    public partial class ImageListView : Control
    {
		...
		public ImageListViewItem LastDrawnGalleryItem { get; set; }
		public Rectangle GalleryRectangle { get; set; }
        #endregion
        ...
        public ImageListView()
        {
			...
			mDefaultImage = ImageListViewResources.DefaultImage;// manager.GetObject("DefaultImage") as Image;
			mErrorImage = ImageListViewResources.ErrorImage; // manager.GetObject("ErrorImage") as Image;
